...
const Navbar = () => {
    ...
    `}>
        <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
            ...
            >
                <img src="/assets/WT.png" alt="logo" className="w-9 h-9 object-contain" />
                <p className="text-white text-[18px] font-bold cursor-pointer">WillyThinks <span className="sm:block hidden"> | Portfolio Walkthrough</span></p>
            </Link>
